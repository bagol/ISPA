  ...
  <div class="row">
    <div class="col-xl-8 col-lg-7 ">
        ...
        <div class="card shadow mb-4" style="overflow-x: unset;">
          ...
          <div class="card-body">
              <form action="<?= base_url() ?>Artikel/insert" method="post" enctype="multipart/form-data">
                <table class="form-artikel">
                  ...
                  <tr>
                    ...
                    <td>
                        <div class="custom-file">
                          ...
                          <label class="custom-file-label" for="customFile" id="label"></label>
                        </div>
                  ...
                  <tr>
                    <td colspan="2 mt-4">
                        <textarea name="artikel" id="texteditor" ></textarea>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">
